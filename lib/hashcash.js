(function() {
  ...
  function sign(challenge) {
    return hash(challenge + SECRET);
  }

  function unsignedChallenge(challenge) {
    var i = challenge.lastIndexOf(':');
    return challenge.slice(0,i);
  }

  function getSignature(challenge) {
    var i = challenge.lastIndexOf(':');
    return challenge.slice(i+1);
  }

  function checkSignature(challenge) {
    return sign(unsignedChallenge(challenge)) === getSignature(challenge);
  }
